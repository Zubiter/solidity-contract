...
// Clonable fork from @openzeppelin/contracts/token/ERC721/ERC721.sol
...
contract ClonableERC721 is Context, IERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    */
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ClonableERC721.ownerOf(tokenId);
        require(to != owner, "ERC721: approval to current owner");

        require(_msgSender() == owner || ClonableERC721.isApprovedForAll(owner, _msgSender()),
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
        ...
        address owner = ClonableERC721.ownerOf(tokenId);
        return (spender == owner || getApproved(tokenId) == spender || ClonableERC721.isApprovedForAll(owner, spender));
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        address owner = ClonableERC721.ownerOf(tokenId); // internal owner
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(ClonableERC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own"); // internal owner
    ...
    function _approve(address to, uint256 tokenId) private {
        ...
        emit Approval(ClonableERC721.ownerOf(tokenId), to, tokenId); // internal owner
    }
